                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (selected_item.equals("Gas")) {
                            ...
                            for (DataSnapshot burner : snapshot.child("Burners").getChildren()) {
                                ...
                                list.add(new vicmak_display_p("Burners " + burner.getKey(), burner.child("image_url").getValue(String.class),
                            ...
                            for (DataSnapshot regulator : snapshot.child("Regulators").getChildren()) {
                                ...
                                list.add(new vicmak_display_p("Regulators " + regulator.getKey(), regulator.child("image_url").getValue(String.class),
